...
namespace PerilDungeon.Classes.Encounters
{
    public class MerchantThieveryEncounter : IEncounter
    {
        ...
        public string Description { get => "You encounter a worn-out thief who's also undergoing the Ordeal. He offers to show you some useful tricks for $150, which he intends to trade for some healing potions."; set { } }
        ...
        public IEnumerable<IEncounterChoice> Choices
        {
            get
            {
                ...
                {
                    choices.Add(new MerchantBuyEncounterChoice(c, Party, 150, Effect, "You pay the old thief. He spends a few hours showing {0} some useful moves to handle the common traps and creatures in the Delve."));
                }
