...
namespace PerilDungeon.Classes.Encounters
{
    class MerchantClothesEncounter : IEncounter
    {
        ...
        public string Description { get => "In a corridor filled with intimidating, sticky spiderwebs, you come upon a small hut carved into the stone. Inside are a trio of humanoid spiders! They're scary, but they seem used to this reaction, and they greet you. In exchange for some of your supplies and treasures worth $150, they can equip one of you with protective spidersilk clothes that will not only keep you warm, but help protect against injury."; set { } }
        ...
        public IEnumerable<IEncounterChoice> Choices
        {
            get
            {
                ...
                {
                    choices.Add(new MerchantBuyEncounterChoice(c, Party, 150, Effect, "You pay the spiderfolk. They measure {0} and with startling speed, weave a tough, new suit of clothes that fit {0} perfectly."));
                }
